...
declare namespace InstanceType {
	class DafultGround extends ISpriteInstance {
	}
	...
	class DrawingCanvas extends IDrawingCanvasInstance {
	}
	...
	class __DebugMessageTextBehaviors<InstType> {
		Timer: ITimerBehaviorInstance<InstType>;
	}
	class DebugMessageText extends ITextInstance {
		behaviors: __DebugMessageTextBehaviors<this>;
	}
